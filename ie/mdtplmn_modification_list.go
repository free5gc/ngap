...
var _ ProtocolIE = &MDTPLMNModificationList{}

type MDTPLMNModificationList struct {
	List []PLMNIdentity // sizeLB:0,sizeUB:16
}

func (x *MDTPLMNModificationList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *MDTPLMNModificationList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *MDTPLMNModificationList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *MDTPLMNModificationList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
