...
var _ ProtocolIE = &AMFTNLAssociationToAddList{}

type AMFTNLAssociationToAddList struct {
	List []AMFTNLAssociationToAddItem // valueExt,sizeLB:1,sizeUB:32
}

func (x *AMFTNLAssociationToAddList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *AMFTNLAssociationToAddList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 32
	...
	x.List = []AMFTNLAssociationToAddItem{}
	for i := 0; i < int(numElements); i++ {
		var val AMFTNLAssociationToAddItem
...
func (x *AMFTNLAssociationToAddList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *AMFTNLAssociationToAddList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
