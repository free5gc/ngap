...
var _ ProtocolIE = &EnhancedCoverageRestriction{}

const ( /* Enum Type */
	EnhancedCoverageRestrictionPresentRestricted aper.Enumerated = 0
)
...
func (x *EnhancedCoverageRestriction) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *EnhancedCoverageRestriction) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *EnhancedCoverageRestriction) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *EnhancedCoverageRestriction) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
