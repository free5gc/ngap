...
var _ ProtocolIE = &UERadioCapabilityID{}

type UERadioCapabilityID struct {
	Value aper.OctetString
}

func (x *UERadioCapabilityID) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UERadioCapabilityID) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *UERadioCapabilityID) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UERadioCapabilityID) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
