...
var _ ProtocolIE = &RRCEstablishmentCause{}
...
type RRCEstablishmentCause struct {
	Value aper.Enumerated // valueExt,valueLB:0,valueUB:9
}

func (x *RRCEstablishmentCause) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *RRCEstablishmentCause) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *RRCEstablishmentCause) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *RRCEstablishmentCause) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
