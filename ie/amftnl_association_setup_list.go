...
var _ ProtocolIE = &AMFTNLAssociationSetupList{}

type AMFTNLAssociationSetupList struct {
	List []AMFTNLAssociationSetupItem // valueExt,sizeLB:1,sizeUB:32
}

func (x *AMFTNLAssociationSetupList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *AMFTNLAssociationSetupList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 32
	...
	x.List = []AMFTNLAssociationSetupItem{}
	for i := 0; i < int(numElements); i++ {
		var val AMFTNLAssociationSetupItem
...
func (x *AMFTNLAssociationSetupList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *AMFTNLAssociationSetupList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
