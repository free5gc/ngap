...
var _ ProtocolIE = &AllowedNSSAI{}

type AllowedNSSAI struct {
	List []AllowedNSSAIItem // valueExt,sizeLB:1,sizeUB:8
}

func (x *AllowedNSSAI) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *AllowedNSSAI) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 8
	...
	x.List = []AllowedNSSAIItem{}
	for i := 0; i < int(numElements); i++ {
		var val AllowedNSSAIItem
...
func (x *AllowedNSSAI) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *AllowedNSSAI) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
