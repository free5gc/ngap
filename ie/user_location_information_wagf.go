...
var _ ProtocolIE = &UserLocationInformationWAGF{}

type UserLocationInformationWAGF struct {
	Choice UserLocationInformationWAGFAlt
}

type UserLocationInformationWAGFAlt interface {
	UserLocationInformationWAGFAltIndex() int64
	Write(*aper.PerBitData) error
	Read(*aper.PerBitData) error
}

// Choice type and its Read/Write is defined elsewhere
func (alt0 GlobalLineID) UserLocationInformationWAGFAltIndex() int64 {
	return int64(0)
}

// Choice type and its Read/Write is defined elsewhere
func (alt1 HFCNodeID) UserLocationInformationWAGFAltIndex() int64 {
	return int64(1)
}

// Choice type and its Read/Write is defined elsewhere
func (alt2 ProtocolIESingleContainerUserLocationInformationWAGFExtIEs) UserLocationInformationWAGFAltIndex() int64 {
	return int64(2)
}

// Choice Type Read/Write Functions

func (x *UserLocationInformationWAGF) Write(pd *aper.PerBitData) error {
	var err error
	...
	var option_idx int64 = x.Choice.UserLocationInformationWAGFAltIndex()
...
func (x *UserLocationInformationWAGF) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	// Read Choice
	if option_idx == 0 {
		x.Choice = new(GlobalLineID)
	} else if option_idx == 1 {
		x.Choice = new(HFCNodeID)
	} else if option_idx == 2 {
		x.Choice = new(ProtocolIESingleContainerUserLocationInformationWAGFExtIEs)
	} else {
...
func (x *UserLocationInformationWAGF) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UserLocationInformationWAGF) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
