...
var _ ProtocolIE = &IABAuthorized{}

const ( /* Enum Type */
	IABAuthorizedPresentAuthorized    aper.Enumerated = 0
	IABAuthorizedPresentNotAuthorized aper.Enumerated = 1
)
...
func (x *IABAuthorized) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *IABAuthorized) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *IABAuthorized) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *IABAuthorized) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
