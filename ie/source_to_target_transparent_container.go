...
var _ ProtocolIE = &SourceToTargetTransparentContainer{}

type SourceToTargetTransparentContainer struct {
	Value aper.OctetString
}

func (x *SourceToTargetTransparentContainer) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SourceToTargetTransparentContainer) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *SourceToTargetTransparentContainer) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SourceToTargetTransparentContainer) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
