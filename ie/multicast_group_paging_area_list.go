...
var _ ProtocolIE = &MulticastGroupPagingAreaList{}

type MulticastGroupPagingAreaList struct {
	List []MulticastGroupPagingAreaItem // valueExt,sizeLB:1,sizeUB:64
}

func (x *MulticastGroupPagingAreaList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *MulticastGroupPagingAreaList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 64
	...
	x.List = []MulticastGroupPagingAreaItem{}
	for i := 0; i < int(numElements); i++ {
		var val MulticastGroupPagingAreaItem
...
func (x *MulticastGroupPagingAreaList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *MulticastGroupPagingAreaList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
