...
var _ ProtocolIE = &EDTSession{}

const ( /* Enum Type */
	EDTSessionPresentTrue aper.Enumerated = 0
)
...
func (x *EDTSession) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *EDTSession) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *EDTSession) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *EDTSession) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
