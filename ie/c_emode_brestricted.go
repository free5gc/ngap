...
var _ ProtocolIE = &CEmodeBrestricted{}

const ( /* Enum Type */
	CEmodeBrestrictedPresentRestricted    aper.Enumerated = 0
	CEmodeBrestrictedPresentNotRestricted aper.Enumerated = 1
)
...
func (x *CEmodeBrestricted) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *CEmodeBrestricted) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *CEmodeBrestricted) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *CEmodeBrestricted) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
