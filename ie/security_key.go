...
var _ ProtocolIE = &SecurityKey{}

type SecurityKey struct {
	Value aper.BitString // sizeLB:256,sizeUB:256
}

func (x *SecurityKey) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SecurityKey) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *SecurityKey) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SecurityKey) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
