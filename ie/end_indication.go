...
var _ ProtocolIE = &EndIndication{}

const ( /* Enum Type */
	EndIndicationPresentNoFurtherData     aper.Enumerated = 0
	EndIndicationPresentFurtherDataExists aper.Enumerated = 1
)
...
func (x *EndIndication) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *EndIndication) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *EndIndication) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *EndIndication) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
