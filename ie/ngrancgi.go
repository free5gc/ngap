...
var _ ProtocolIE = &NGRANCGI{}

type NGRANCGI struct {
	Choice NGRANCGIAlt
}

type NGRANCGIAlt interface {
	NGRANCGIAltIndex() int64
	Write(*aper.PerBitData) error
	Read(*aper.PerBitData) error
}

// Choice type and its Read/Write is defined elsewhere
func (alt0 NRCGI) NGRANCGIAltIndex() int64 {
	return int64(0)
}

// Choice type and its Read/Write is defined elsewhere
func (alt1 EUTRACGI) NGRANCGIAltIndex() int64 {
	return int64(1)
}

// Choice type and its Read/Write is defined elsewhere
func (alt2 ProtocolIESingleContainerNGRANCGIExtIEs) NGRANCGIAltIndex() int64 {
	return int64(2)
}
...
func (x *NGRANCGI) Write(pd *aper.PerBitData) error {
	...
	var option_idx int64 = x.Choice.NGRANCGIAltIndex()
...
func (x *NGRANCGI) Read(pd *aper.PerBitData) error {
	...
	if option_idx == 0 {
		...
		x.Choice = new(EUTRACGI)
	} else if option_idx == 2 {
		x.Choice = new(ProtocolIESingleContainerNGRANCGIExtIEs)
	} else {
...
func (x *NGRANCGI) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *NGRANCGI) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
