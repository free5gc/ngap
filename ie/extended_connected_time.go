...
var _ ProtocolIE = &ExtendedConnectedTime{}

type ExtendedConnectedTime struct {
	Value int64 // valueLB:0,valueUB:255
}

func (x *ExtendedConnectedTime) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *ExtendedConnectedTime) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *ExtendedConnectedTime) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *ExtendedConnectedTime) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
