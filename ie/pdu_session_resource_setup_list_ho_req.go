...
var _ ProtocolIE = &PDUSessionResourceSetupListHOReq{}

type PDUSessionResourceSetupListHOReq struct {
	List []PDUSessionResourceSetupItemHOReq // valueExt,sizeLB:1,sizeUB:256
}

func (x *PDUSessionResourceSetupListHOReq) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *PDUSessionResourceSetupListHOReq) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 256
	...
	x.List = []PDUSessionResourceSetupItemHOReq{}
	for i := 0; i < int(numElements); i++ {
		var val PDUSessionResourceSetupItemHOReq
...
func (x *PDUSessionResourceSetupListHOReq) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *PDUSessionResourceSetupListHOReq) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
