...
var _ ProtocolIE = &NetworkInstance{}

type NetworkInstance struct {
	Value int64 // valueExt,valueLB:1,valueUB:256
}

func (x *NetworkInstance) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *NetworkInstance) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *NetworkInstance) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *NetworkInstance) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
