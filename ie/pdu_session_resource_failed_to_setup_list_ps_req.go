...
var _ ProtocolIE = &PDUSessionResourceFailedToSetupListPSReq{}

type PDUSessionResourceFailedToSetupListPSReq struct {
	List []PDUSessionResourceFailedToSetupItemPSReq // valueExt,sizeLB:1,sizeUB:256
}

func (x *PDUSessionResourceFailedToSetupListPSReq) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *PDUSessionResourceFailedToSetupListPSReq) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 256
	...
	x.List = []PDUSessionResourceFailedToSetupItemPSReq{}
	for i := 0; i < int(numElements); i++ {
		var val PDUSessionResourceFailedToSetupItemPSReq
...
func (x *PDUSessionResourceFailedToSetupListPSReq) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *PDUSessionResourceFailedToSetupListPSReq) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
