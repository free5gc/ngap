...
var _ ProtocolIE = &SuccessfulHandoverReportList{}

type SuccessfulHandoverReportList struct {
	List []SuccessfulHandoverReportItem // valueExt,sizeLB:1,sizeUB:64
}

func (x *SuccessfulHandoverReportList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SuccessfulHandoverReportList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 64
	...
	x.List = []SuccessfulHandoverReportItem{}
	for i := 0; i < int(numElements); i++ {
		var val SuccessfulHandoverReportItem
...
func (x *SuccessfulHandoverReportList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SuccessfulHandoverReportList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
