...
var _ ProtocolIE = &SONInformationReport{}

type SONInformationReport struct {
	Choice SONInformationReportAlt
}

type SONInformationReportAlt interface {
	SONInformationReportAltIndex() int64
	Write(*aper.PerBitData) error
	Read(*aper.PerBitData) error
}

// Choice type and its Read/Write is defined elsewhere
func (alt0 FailureIndication) SONInformationReportAltIndex() int64 {
	return int64(0)
}

// Choice type and its Read/Write is defined elsewhere
func (alt1 HOReport) SONInformationReportAltIndex() int64 {
	return int64(1)
}

// Choice type and its Read/Write is defined elsewhere
func (alt2 ProtocolIESingleContainerSONInformationReportExtIEs) SONInformationReportAltIndex() int64 {
	return int64(2)
}

// Choice Type Read/Write Functions

func (x *SONInformationReport) Write(pd *aper.PerBitData) error {
	var err error
	...
	var option_idx int64 = x.Choice.SONInformationReportAltIndex()
...
func (x *SONInformationReport) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	// Read Choice
	if option_idx == 0 {
		x.Choice = new(FailureIndication)
	} else if option_idx == 1 {
		x.Choice = new(HOReport)
	} else if option_idx == 2 {
		x.Choice = new(ProtocolIESingleContainerSONInformationReportExtIEs)
	} else {
...
func (x *SONInformationReport) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SONInformationReport) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
