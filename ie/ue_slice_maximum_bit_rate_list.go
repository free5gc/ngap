...
var _ ProtocolIE = &UESliceMaximumBitRateList{}

type UESliceMaximumBitRateList struct {
	List []UESliceMaximumBitRateItem // valueExt,sizeLB:1,sizeUB:8
}

func (x *UESliceMaximumBitRateList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UESliceMaximumBitRateList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 8
	...
	x.List = []UESliceMaximumBitRateItem{}
	for i := 0; i < int(numElements); i++ {
		var val UESliceMaximumBitRateItem
...
func (x *UESliceMaximumBitRateList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UESliceMaximumBitRateList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
