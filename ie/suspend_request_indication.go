...
var _ ProtocolIE = &SuspendRequestIndication{}

const ( /* Enum Type */
	SuspendRequestIndicationPresentSuspendRequested aper.Enumerated = 0
)
...
func (x *SuspendRequestIndication) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SuspendRequestIndication) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *SuspendRequestIndication) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SuspendRequestIndication) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
