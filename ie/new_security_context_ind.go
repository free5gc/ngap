...
var _ ProtocolIE = &NewSecurityContextInd{}
...
func (x *NewSecurityContextInd) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *NewSecurityContextInd) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *NewSecurityContextInd) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *NewSecurityContextInd) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
