...
var _ ProtocolIE = &AMFTNLAssociationToRemoveList{}

type AMFTNLAssociationToRemoveList struct {
	List []AMFTNLAssociationToRemoveItem // valueExt,sizeLB:1,sizeUB:32
}

func (x *AMFTNLAssociationToRemoveList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *AMFTNLAssociationToRemoveList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 32
	...
	x.List = []AMFTNLAssociationToRemoveItem{}
	for i := 0; i < int(numElements); i++ {
		var val AMFTNLAssociationToRemoveItem
...
func (x *AMFTNLAssociationToRemoveList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *AMFTNLAssociationToRemoveList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
