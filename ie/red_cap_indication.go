...
var _ ProtocolIE = &RedCapIndication{}

const ( /* Enum Type */
	RedCapIndicationPresentRedcap aper.Enumerated = 0
)
...
func (x *RedCapIndication) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *RedCapIndication) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *RedCapIndication) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *RedCapIndication) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
