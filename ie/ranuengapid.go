...
var _ ProtocolIE = &RANUENGAPID{}

type RANUENGAPID struct {
	Value int64 // valueLB:0,valueUB:4294967295
}

func (x *RANUENGAPID) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *RANUENGAPID) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *RANUENGAPID) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *RANUENGAPID) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
