...
type ActivatedCellList struct {
	List []NGRANCGI // sizeLB:1,sizeUB:16384
}

func (x *ActivatedCellList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *ActivatedCellList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
