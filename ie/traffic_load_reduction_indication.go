...
var _ ProtocolIE = &TrafficLoadReductionIndication{}

type TrafficLoadReductionIndication struct {
	Value int64 // valueLB:1,valueUB:99
}

func (x *TrafficLoadReductionIndication) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *TrafficLoadReductionIndication) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *TrafficLoadReductionIndication) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *TrafficLoadReductionIndication) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
