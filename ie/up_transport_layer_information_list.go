...
var _ ProtocolIE = &UPTransportLayerInformationList{}

type UPTransportLayerInformationList struct {
	List []UPTransportLayerInformationItem // valueExt,sizeLB:1,sizeUB:3
}

func (x *UPTransportLayerInformationList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UPTransportLayerInformationList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 3
	...
	x.List = []UPTransportLayerInformationItem{}
	for i := 0; i < int(numElements); i++ {
		var val UPTransportLayerInformationItem
...
func (x *UPTransportLayerInformationList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UPTransportLayerInformationList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
