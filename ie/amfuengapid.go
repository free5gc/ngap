...
var _ ProtocolIE = &AMFUENGAPID{}

type AMFUENGAPID struct {
	Value int64 // valueLB:0,valueUB:1099511627775
}

func (x *AMFUENGAPID) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *AMFUENGAPID) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *AMFUENGAPID) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *AMFUENGAPID) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
