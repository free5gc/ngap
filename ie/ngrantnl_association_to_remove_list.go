...
var _ ProtocolIE = &NGRANTNLAssociationToRemoveList{}

type NGRANTNLAssociationToRemoveList struct {
	List []NGRANTNLAssociationToRemoveItem // sizeLB:1,sizeUB:32
}

func (x *NGRANTNLAssociationToRemoveList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *NGRANTNLAssociationToRemoveList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 32
	...
	x.List = []NGRANTNLAssociationToRemoveItem{}
	for i := 0; i < int(numElements); i++ {
		var val NGRANTNLAssociationToRemoveItem
...
func (x *NGRANTNLAssociationToRemoveList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *NGRANTNLAssociationToRemoveList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
