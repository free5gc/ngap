...
var _ ProtocolIE = &WarningType{}

type WarningType struct {
	Value aper.OctetString // sizeLB:2,sizeUB:2
}

func (x *WarningType) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *WarningType) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *WarningType) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *WarningType) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
