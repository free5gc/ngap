...
var _ ProtocolIE = &PrivacyIndicator{}

const ( /* Enum Type */
	PrivacyIndicatorPresentImmediateMDT aper.Enumerated = 0
	PrivacyIndicatorPresentLoggedMDT    aper.Enumerated = 1
)
...
func (x *PrivacyIndicator) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *PrivacyIndicator) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *PrivacyIndicator) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *PrivacyIndicator) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
