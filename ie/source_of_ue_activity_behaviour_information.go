...
func (x *SourceOfUEActivityBehaviourInformation) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SourceOfUEActivityBehaviourInformation) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
