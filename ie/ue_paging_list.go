...
type UEPagingList struct {
	List []UEPagingItem // valueExt,sizeLB:1,sizeUB:4096
}

func (x *UEPagingList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UEPagingList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
