...
type TWIFIDAlt interface {
	TWIFIDAltIndex() int64
...
type TWIFIDForTWIFID struct {
	Value aper.BitString
}

func (alt0 *TWIFIDForTWIFID) TWIFIDAltIndex() int64 {
	return int64(0)
}

func (x *TWIFIDForTWIFID) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *TWIFIDForTWIFID) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (alt1 ProtocolIESingleContainerTWIFIDExtIEs) TWIFIDAltIndex() int64 {
	return int64(1)
}

// Choice Type Read/Write Functions

func (x *TWIFID) Write(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	var option_idx int64 = x.Choice.TWIFIDAltIndex()
...
func (x *TWIFID) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	// Read Choice
	if option_idx == 0 {
		x.Choice = new(TWIFIDForTWIFID)
	} else if option_idx == 1 {
		x.Choice = new(ProtocolIESingleContainerTWIFIDExtIEs)
	} else {
