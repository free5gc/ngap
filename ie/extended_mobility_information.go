...
type ExtendedMobilityInformation struct {
	Value aper.BitString // sizeLB:32,sizeUB:32
}

func (x *ExtendedMobilityInformation) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *ExtendedMobilityInformation) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
