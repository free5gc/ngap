...
var _ ProtocolIE = &PWSFailedCellIDList{}

type PWSFailedCellIDList struct {
	Choice PWSFailedCellIDListAlt
}

type PWSFailedCellIDListAlt interface {
	PWSFailedCellIDListAltIndex() int64
	Write(*aper.PerBitData) error
	Read(*aper.PerBitData) error
}

// Choice type and its Read/Write is defined elsewhere
func (alt0 EUTRACGIList) PWSFailedCellIDListAltIndex() int64 {
	return int64(0)
}

// Choice type and its Read/Write is defined elsewhere
func (alt1 NRCGIList) PWSFailedCellIDListAltIndex() int64 {
	return int64(1)
}

// Choice type and its Read/Write is defined elsewhere
func (alt2 ProtocolIESingleContainerPWSFailedCellIDListExtIEs) PWSFailedCellIDListAltIndex() int64 {
	return int64(2)
}

// Choice Type Read/Write Functions

func (x *PWSFailedCellIDList) Write(pd *aper.PerBitData) error {
	var err error
	...
	var option_idx int64 = x.Choice.PWSFailedCellIDListAltIndex()
...
func (x *PWSFailedCellIDList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	if option_idx == 0 {
		...
		x.Choice = new(ProtocolIESingleContainerPWSFailedCellIDListExtIEs)
	} else {
...
func (x *PWSFailedCellIDList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *PWSFailedCellIDList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
