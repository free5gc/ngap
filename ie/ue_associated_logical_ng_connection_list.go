...
var _ ProtocolIE = &UEAssociatedLogicalNGConnectionList{}

type UEAssociatedLogicalNGConnectionList struct {
	List []UEAssociatedLogicalNGConnectionItem // valueExt,sizeLB:1,sizeUB:65536
}

func (x *UEAssociatedLogicalNGConnectionList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UEAssociatedLogicalNGConnectionList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 65536
	...
	x.List = []UEAssociatedLogicalNGConnectionItem{}
	for i := 0; i < int(numElements); i++ {
		var val UEAssociatedLogicalNGConnectionItem
...
func (x *UEAssociatedLogicalNGConnectionList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UEAssociatedLogicalNGConnectionList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
