...
type RejectedNSSAIinPLMN struct {
	Value aper.OctetString // sizeLB:32,sizeUB:32
}

func (x *RejectedNSSAIinPLMN) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *RejectedNSSAIinPLMN) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
