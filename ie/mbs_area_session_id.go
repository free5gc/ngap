...
var _ ProtocolIE = &MBSAreaSessionID{}

type MBSAreaSessionID struct {
	Value int64 // valueExt,valueLB:0,valueUB:65535
}

func (x *MBSAreaSessionID) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *MBSAreaSessionID) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *MBSAreaSessionID) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *MBSAreaSessionID) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
