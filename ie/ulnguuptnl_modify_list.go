...
var _ ProtocolIE = &ULNGUUPTNLModifyList{}

type ULNGUUPTNLModifyList struct {
	List []ULNGUUPTNLModifyItem // valueExt,sizeLB:1,sizeUB:4
}

func (x *ULNGUUPTNLModifyList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *ULNGUUPTNLModifyList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 4
	...
	x.List = []ULNGUUPTNLModifyItem{}
	for i := 0; i < int(numElements); i++ {
		var val ULNGUUPTNLModifyItem
...
func (x *ULNGUUPTNLModifyList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *ULNGUUPTNLModifyList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
