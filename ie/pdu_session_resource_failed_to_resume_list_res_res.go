...
var _ ProtocolIE = &PDUSessionResourceFailedToResumeListRESRes{}

type PDUSessionResourceFailedToResumeListRESRes struct {
	List []PDUSessionResourceFailedToResumeItemRESRes // valueExt,sizeLB:1,sizeUB:256
}

func (x *PDUSessionResourceFailedToResumeListRESRes) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *PDUSessionResourceFailedToResumeListRESRes) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 256
	...
	x.List = []PDUSessionResourceFailedToResumeItemRESRes{}
	for i := 0; i < int(numElements); i++ {
		var val PDUSessionResourceFailedToResumeItemRESRes
...
func (x *PDUSessionResourceFailedToResumeListRESRes) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *PDUSessionResourceFailedToResumeListRESRes) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
