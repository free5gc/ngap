...
func (x *DeactivateTrace) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *DeactivateTrace) ProcedureCode() int64 {
	return ProcedureCodeDeactivateTrace
}

func (x *DeactivateTrace) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *DeactivateTrace) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: DeactivateTrace (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *DeactivateTrace) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (DeactivateTrace) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
