...
func (x *BroadcastSessionSetupFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *BroadcastSessionSetupFailure) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionSetup
}

func (x *BroadcastSessionSetupFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionSetupFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionSetupFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionSetupFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionSetupFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
