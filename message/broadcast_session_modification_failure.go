...
func (x *BroadcastSessionModificationFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *BroadcastSessionModificationFailure) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionModification
}

func (x *BroadcastSessionModificationFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionModificationFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionModificationFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionModificationFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionModificationFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
