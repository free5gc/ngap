...
func (x *MulticastSessionActivationFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *MulticastSessionActivationFailure) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionActivation
}

func (x *MulticastSessionActivationFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionActivationFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionActivationFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionActivationFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionActivationFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
