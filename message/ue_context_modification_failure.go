...
func (x *UEContextModificationFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *UEContextModificationFailure) ProcedureCode() int64 {
	return ProcedureCodeUEContextModification
}

func (x *UEContextModificationFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *UEContextModificationFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UEContextModificationFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UEContextModificationFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UEContextModificationFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
