...
func (x *UplinkRANEarlyStatusTransfer) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UplinkRANEarlyStatusTransfer) ProcedureCode() int64 {
	return ProcedureCodeUplinkRANEarlyStatusTransfer
}

func (x *UplinkRANEarlyStatusTransfer) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *UplinkRANEarlyStatusTransfer) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UplinkRANEarlyStatusTransfer (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UplinkRANEarlyStatusTransfer) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UplinkRANEarlyStatusTransfer) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
