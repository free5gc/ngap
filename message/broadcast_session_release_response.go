...
func (x *BroadcastSessionReleaseResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *BroadcastSessionReleaseResponse) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionRelease
}

func (x *BroadcastSessionReleaseResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionReleaseResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionReleaseResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionReleaseResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionReleaseResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
