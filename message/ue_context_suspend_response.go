...
func (x *UEContextSuspendResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *UEContextSuspendResponse) ProcedureCode() int64 {
	return ProcedureCodeUEContextSuspend
}

func (x *UEContextSuspendResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *UEContextSuspendResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UEContextSuspendResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UEContextSuspendResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UEContextSuspendResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
