...
func (x *BroadcastSessionModificationRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *BroadcastSessionModificationRequest) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionModification
}

func (x *BroadcastSessionModificationRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionModificationRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionModificationRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionModificationRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionModificationRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
