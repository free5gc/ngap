...
func (x *BroadcastSessionSetupResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *BroadcastSessionSetupResponse) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionSetup
}

func (x *BroadcastSessionSetupResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionSetupResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionSetupResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionSetupResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionSetupResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
