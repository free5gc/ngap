...
func (x *DistributionSetupResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *DistributionSetupResponse) ProcedureCode() int64 {
	return ProcedureCodeDistributionSetup
}

func (x *DistributionSetupResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *DistributionSetupResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: DistributionSetupResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *DistributionSetupResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (DistributionSetupResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
