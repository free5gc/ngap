...
func (x *NASNonDeliveryIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *NASNonDeliveryIndication) ProcedureCode() int64 {
	return ProcedureCodeNASNonDeliveryIndication
}

func (x *NASNonDeliveryIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *NASNonDeliveryIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: NASNonDeliveryIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *NASNonDeliveryIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (NASNonDeliveryIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	// NASPDU is mandatory but may be nil (ignored)
