...
func (x *DistributionReleaseResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *DistributionReleaseResponse) ProcedureCode() int64 {
	return ProcedureCodeDistributionRelease
}

func (x *DistributionReleaseResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *DistributionReleaseResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: DistributionReleaseResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *DistributionReleaseResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (DistributionReleaseResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
