...
type InitialContextSetupResponse struct {
	...
	PDUSessionResourceSetupListCxtRes         *ie.PDUSessionResourceSetupListCxtRes         // optional
	PDUSessionResourceFailedToSetupListCxtRes *ie.PDUSessionResourceFailedToSetupListCxtRes // optional
	CriticalityDiagnostics                    *ie.CriticalityDiagnostics                    // optional
}

func (x *InitialContextSetupResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *InitialContextSetupResponse) ProcedureCode() int64 {
	return ProcedureCodeInitialContextSetup
}

func (x *InitialContextSetupResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *InitialContextSetupResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: InitialContextSetupResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	if x.PDUSessionResourceSetupListCxtRes != nil {
		numIes++
	}
	if x.PDUSessionResourceFailedToSetupListCxtRes != nil {
		numIes++
	}
	...
	// IE Field 3 (optional)
	if x.PDUSessionResourceSetupListCxtRes != nil {
		err = x.PDUSessionResourceSetupListCxtRes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceSetupListCxtRes},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 4 (optional)
	if x.PDUSessionResourceFailedToSetupListCxtRes != nil {
		err = x.PDUSessionResourceFailedToSetupListCxtRes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceFailedToSetupListCxtRes},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *InitialContextSetupResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (InitialContextSetupResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceSetupListCxtRes {
			// check if ie is duplicated
			if x.PDUSessionResourceSetupListCxtRes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceSetupListCxtRes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceSetupListCxtRes = &ie.PDUSessionResourceSetupListCxtRes{}
			err = x.PDUSessionResourceSetupListCxtRes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceFailedToSetupListCxtRes {
			// check if ie is duplicated
			if x.PDUSessionResourceFailedToSetupListCxtRes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceFailedToSetupListCxtRes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceFailedToSetupListCxtRes = &ie.PDUSessionResourceFailedToSetupListCxtRes{}
			err = x.PDUSessionResourceFailedToSetupListCxtRes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
