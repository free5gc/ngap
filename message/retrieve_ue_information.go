...
func (x *RetrieveUEInformation) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *RetrieveUEInformation) ProcedureCode() int64 {
	return ProcedureCodeRetrieveUEInformation
}

func (x *RetrieveUEInformation) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *RetrieveUEInformation) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: RetrieveUEInformation (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *RetrieveUEInformation) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (RetrieveUEInformation) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
