...
func (x *NGSetupFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *NGSetupFailure) ProcedureCode() int64 {
	return ProcedureCodeNGSetup
}

func (x *NGSetupFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *NGSetupFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: NGSetupFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *NGSetupFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (NGSetupFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
