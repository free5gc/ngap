...
func (x *LocationReportingFailureIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *LocationReportingFailureIndication) ProcedureCode() int64 {
	return ProcedureCodeLocationReportingFailureIndication
}

func (x *LocationReportingFailureIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *LocationReportingFailureIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: LocationReportingFailureIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *LocationReportingFailureIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (LocationReportingFailureIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
