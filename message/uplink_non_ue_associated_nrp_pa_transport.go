...
func (x *UplinkNonUEAssociatedNRPPaTransport) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UplinkNonUEAssociatedNRPPaTransport) ProcedureCode() int64 {
	return ProcedureCodeUplinkNonUEAssociatedNRPPaTransport
}

func (x *UplinkNonUEAssociatedNRPPaTransport) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *UplinkNonUEAssociatedNRPPaTransport) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UplinkNonUEAssociatedNRPPaTransport (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UplinkNonUEAssociatedNRPPaTransport) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UplinkNonUEAssociatedNRPPaTransport) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
