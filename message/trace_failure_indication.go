...
func (x *TraceFailureIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *TraceFailureIndication) ProcedureCode() int64 {
	return ProcedureCodeTraceFailureIndication
}

func (x *TraceFailureIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *TraceFailureIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: TraceFailureIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *TraceFailureIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (TraceFailureIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
