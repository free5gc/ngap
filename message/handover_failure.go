...
func (x *HandoverFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *HandoverFailure) ProcedureCode() int64 {
	return ProcedureCodeHandoverResourceAllocation
}

func (x *HandoverFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *HandoverFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: HandoverFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *HandoverFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (HandoverFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
