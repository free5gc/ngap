...
type PDUSessionResourceModifyResponse struct {
	...
	PDUSessionResourceModifyListModRes         *ie.PDUSessionResourceModifyListModRes         // optional
	PDUSessionResourceFailedToModifyListModRes *ie.PDUSessionResourceFailedToModifyListModRes // optional
	UserLocationInformation                    *ie.UserLocationInformation                    // optional
	CriticalityDiagnostics                     *ie.CriticalityDiagnostics                     // optional
}

func (x *PDUSessionResourceModifyResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *PDUSessionResourceModifyResponse) ProcedureCode() int64 {
	return ProcedureCodePDUSessionResourceModify
}

func (x *PDUSessionResourceModifyResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *PDUSessionResourceModifyResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: PDUSessionResourceModifyResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	if x.PDUSessionResourceModifyListModRes != nil {
		numIes++
	}
	if x.PDUSessionResourceFailedToModifyListModRes != nil {
		numIes++
	}
	...
	// IE Field 3 (optional)
	if x.PDUSessionResourceModifyListModRes != nil {
		err = x.PDUSessionResourceModifyListModRes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceModifyListModRes},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 4 (optional)
	if x.PDUSessionResourceFailedToModifyListModRes != nil {
		err = x.PDUSessionResourceFailedToModifyListModRes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceFailedToModifyListModRes},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *PDUSessionResourceModifyResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PDUSessionResourceModifyResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceModifyListModRes {
			// check if ie is duplicated
			if x.PDUSessionResourceModifyListModRes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceModifyListModRes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceModifyListModRes = &ie.PDUSessionResourceModifyListModRes{}
			err = x.PDUSessionResourceModifyListModRes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceFailedToModifyListModRes {
			// check if ie is duplicated
			if x.PDUSessionResourceFailedToModifyListModRes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceFailedToModifyListModRes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceFailedToModifyListModRes = &ie.PDUSessionResourceFailedToModifyListModRes{}
			err = x.PDUSessionResourceFailedToModifyListModRes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
