...
func (x *DistributionSetupFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *DistributionSetupFailure) ProcedureCode() int64 {
	return ProcedureCodeDistributionSetup
}

func (x *DistributionSetupFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *DistributionSetupFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: DistributionSetupFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *DistributionSetupFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (DistributionSetupFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
