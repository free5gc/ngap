...
func (x *MulticastSessionDeactivationRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *MulticastSessionDeactivationRequest) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionDeactivation
}

func (x *MulticastSessionDeactivationRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionDeactivationRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionDeactivationRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionDeactivationRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionDeactivationRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
