...
func (x *RANConfigurationUpdateAcknowledge) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *RANConfigurationUpdateAcknowledge) ProcedureCode() int64 {
	return ProcedureCodeRANConfigurationUpdate
}

func (x *RANConfigurationUpdateAcknowledge) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *RANConfigurationUpdateAcknowledge) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: RANConfigurationUpdateAcknowledge (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *RANConfigurationUpdateAcknowledge) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (RANConfigurationUpdateAcknowledge) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
