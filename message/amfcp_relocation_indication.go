...
func (x *AMFCPRelocationIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *AMFCPRelocationIndication) ProcedureCode() int64 {
	return ProcedureCodeAMFCPRelocationIndication
}

func (x *AMFCPRelocationIndication) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *AMFCPRelocationIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: AMFCPRelocationIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *AMFCPRelocationIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (AMFCPRelocationIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
