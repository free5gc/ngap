...
func (x *UplinkUEAssociatedNRPPaTransport) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UplinkUEAssociatedNRPPaTransport) ProcedureCode() int64 {
	return ProcedureCodeUplinkUEAssociatedNRPPaTransport
}

func (x *UplinkUEAssociatedNRPPaTransport) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *UplinkUEAssociatedNRPPaTransport) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UplinkUEAssociatedNRPPaTransport (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UplinkUEAssociatedNRPPaTransport) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UplinkUEAssociatedNRPPaTransport) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
