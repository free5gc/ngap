...
func (x *UplinkRANStatusTransfer) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UplinkRANStatusTransfer) ProcedureCode() int64 {
	return ProcedureCodeUplinkRANStatusTransfer
}

func (x *UplinkRANStatusTransfer) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *UplinkRANStatusTransfer) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UplinkRANStatusTransfer (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UplinkRANStatusTransfer) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UplinkRANStatusTransfer) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
