...
type RRCInactiveTransitionReport struct {
	...
	RRCState                *ie.RRCState                // mandatory
	UserLocationInformation *ie.UserLocationInformation // mandatory
}

func (x *RRCInactiveTransitionReport) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *RRCInactiveTransitionReport) ProcedureCode() int64 {
	return ProcedureCodeRRCInactiveTransitionReport
}

func (x *RRCInactiveTransitionReport) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *RRCInactiveTransitionReport) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: RRCInactiveTransitionReport (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	if x.RRCState != nil {
		...
		return pd.Bytes(), errors.Errorf("mandatory field RRCState is missing")
	}
...
func (x *RRCInactiveTransitionReport) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (RRCInactiveTransitionReport) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	// RRCState is mandatory but may be nil (ignored)
