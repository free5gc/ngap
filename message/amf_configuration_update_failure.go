...
func (x *AMFConfigurationUpdateFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *AMFConfigurationUpdateFailure) ProcedureCode() int64 {
	return ProcedureCodeAMFConfigurationUpdate
}

func (x *AMFConfigurationUpdateFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *AMFConfigurationUpdateFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: AMFConfigurationUpdateFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *AMFConfigurationUpdateFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (AMFConfigurationUpdateFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
