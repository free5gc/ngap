...
func (x *UETNLABindingReleaseRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UETNLABindingReleaseRequest) ProcedureCode() int64 {
	return ProcedureCodeUETNLABindingRelease
}

func (x *UETNLABindingReleaseRequest) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *UETNLABindingReleaseRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UETNLABindingReleaseRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UETNLABindingReleaseRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UETNLABindingReleaseRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
