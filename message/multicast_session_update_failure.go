...
func (x *MulticastSessionUpdateFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *MulticastSessionUpdateFailure) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionUpdate
}

func (x *MulticastSessionUpdateFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionUpdateFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionUpdateFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionUpdateFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionUpdateFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
