...
func (x *MulticastSessionUpdateRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *MulticastSessionUpdateRequest) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionUpdate
}

func (x *MulticastSessionUpdateRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionUpdateRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionUpdateRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionUpdateRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionUpdateRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
