...
func (x *MulticastSessionActivationResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *MulticastSessionActivationResponse) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionActivation
}

func (x *MulticastSessionActivationResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionActivationResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionActivationResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionActivationResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionActivationResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
