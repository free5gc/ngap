...
func (x *MulticastSessionDeactivationResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *MulticastSessionDeactivationResponse) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionDeactivation
}

func (x *MulticastSessionDeactivationResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionDeactivationResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionDeactivationResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionDeactivationResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionDeactivationResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
