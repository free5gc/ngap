...
func (x *HandoverCancel) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *HandoverCancel) ProcedureCode() int64 {
	return ProcedureCodeHandoverCancel
}

func (x *HandoverCancel) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *HandoverCancel) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: HandoverCancel (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *HandoverCancel) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (HandoverCancel) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
