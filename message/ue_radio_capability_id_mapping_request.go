...
func (x *UERadioCapabilityIDMappingRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UERadioCapabilityIDMappingRequest) ProcedureCode() int64 {
	return ProcedureCodeUERadioCapabilityIDMapping
}

func (x *UERadioCapabilityIDMappingRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *UERadioCapabilityIDMappingRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UERadioCapabilityIDMappingRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UERadioCapabilityIDMappingRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UERadioCapabilityIDMappingRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
