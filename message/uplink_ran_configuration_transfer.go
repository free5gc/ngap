...
type UplinkRANConfigurationTransfer struct {
	SONConfigurationTransferUL            *ie.SONConfigurationTransfer            // optional
	ENDCSONConfigurationTransferUL        *ie.ENDCSONConfigurationTransfer        // optional
	IntersystemSONConfigurationTransferUL *ie.IntersystemSONConfigurationTransfer // optional
}

func (x *UplinkRANConfigurationTransfer) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UplinkRANConfigurationTransfer) ProcedureCode() int64 {
	return ProcedureCodeUplinkRANConfigurationTransfer
}

func (x *UplinkRANConfigurationTransfer) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *UplinkRANConfigurationTransfer) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UplinkRANConfigurationTransfer (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	numIes := uint64(0)
	if x.SONConfigurationTransferUL != nil {
		numIes++
	}
	if x.ENDCSONConfigurationTransferUL != nil {
		numIes++
	}
	if x.IntersystemSONConfigurationTransferUL != nil {
		numIes++
	}
	...
	// IE Field 1 (optional)
	if x.SONConfigurationTransferUL != nil {
		err = x.SONConfigurationTransferUL.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDSONConfigurationTransferUL},
	...
	// IE Field 2 (optional)
	if x.ENDCSONConfigurationTransferUL != nil {
		err = x.ENDCSONConfigurationTransferUL.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDENDCSONConfigurationTransferUL},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 3 (optional)
	if x.IntersystemSONConfigurationTransferUL != nil {
		err = x.IntersystemSONConfigurationTransferUL.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDIntersystemSONConfigurationTransferUL},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *UplinkRANConfigurationTransfer) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UplinkRANConfigurationTransfer) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 1
		if protocolIeId == ie.ProtocolIEIDSONConfigurationTransferUL {
			// check if ie is duplicated
			if x.SONConfigurationTransferUL != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: SONConfigurationTransferUL")
			...
			x.SONConfigurationTransferUL = &ie.SONConfigurationTransfer{}
			err = x.SONConfigurationTransferUL.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 2
		if protocolIeId == ie.ProtocolIEIDENDCSONConfigurationTransferUL {
			// check if ie is duplicated
			if x.ENDCSONConfigurationTransferUL != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: ENDCSONConfigurationTransferUL")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.ENDCSONConfigurationTransferUL = &ie.ENDCSONConfigurationTransfer{}
			err = x.ENDCSONConfigurationTransferUL.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDIntersystemSONConfigurationTransferUL {
			// check if ie is duplicated
			if x.IntersystemSONConfigurationTransferUL != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: IntersystemSONConfigurationTransferUL")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.IntersystemSONConfigurationTransferUL = &ie.IntersystemSONConfigurationTransfer{}
			err = x.IntersystemSONConfigurationTransferUL.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
