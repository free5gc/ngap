...
func (x *BroadcastSessionReleaseRequired) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *BroadcastSessionReleaseRequired) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionReleaseRequired
}

func (x *BroadcastSessionReleaseRequired) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionReleaseRequired) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionReleaseRequired (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionReleaseRequired) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionReleaseRequired) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
