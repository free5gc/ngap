...
func (x *LocationReportingControl) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *LocationReportingControl) ProcedureCode() int64 {
	return ProcedureCodeLocationReportingControl
}

func (x *LocationReportingControl) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *LocationReportingControl) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: LocationReportingControl (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *LocationReportingControl) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (LocationReportingControl) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
