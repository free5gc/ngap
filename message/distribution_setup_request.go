...
func (x *DistributionSetupRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *DistributionSetupRequest) ProcedureCode() int64 {
	return ProcedureCodeDistributionSetup
}

func (x *DistributionSetupRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *DistributionSetupRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: DistributionSetupRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *DistributionSetupRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (DistributionSetupRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
