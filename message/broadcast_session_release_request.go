...
func (x *BroadcastSessionReleaseRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *BroadcastSessionReleaseRequest) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionRelease
}

func (x *BroadcastSessionReleaseRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionReleaseRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionReleaseRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionReleaseRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionReleaseRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
