...
type PWSRestartIndication struct {
	CellIDListForRestart          *ie.CellIDListForRestart          // mandatory
	GlobalRANNodeID               *ie.GlobalRANNodeID               // mandatory
	TAIListForRestart             *ie.TAIListForRestart             // mandatory
	EmergencyAreaIDListForRestart *ie.EmergencyAreaIDListForRestart // optional
}

func (x *PWSRestartIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *PWSRestartIndication) ProcedureCode() int64 {
	return ProcedureCodePWSRestartIndication
}

func (x *PWSRestartIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *PWSRestartIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: PWSRestartIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	numIes := uint64(0)
	if x.CellIDListForRestart != nil {
		numIes++
	}
	if x.GlobalRANNodeID != nil {
		numIes++
	}
	if x.TAIListForRestart != nil {
		numIes++
	}
	if x.EmergencyAreaIDListForRestart != nil {
		numIes++
	}
	...
	if x.CellIDListForRestart != nil {
		err = x.CellIDListForRestart.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDCellIDListForRestart},
			ie.ProtocolIECriticality{Value: ie.CriticalityReject})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	} else {
		return pd.Bytes(), errors.Errorf("mandatory field CellIDListForRestart is missing")
	}
	...
	if x.TAIListForRestart != nil {
		err = x.TAIListForRestart.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDTAIListForRestart},
			ie.ProtocolIECriticality{Value: ie.CriticalityReject})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	} else {
		return pd.Bytes(), errors.Errorf("mandatory field TAIListForRestart is missing")
	}

	// IE Field 4 (optional)
	if x.EmergencyAreaIDListForRestart != nil {
		err = x.EmergencyAreaIDListForRestart.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDEmergencyAreaIDListForRestart},
			ie.ProtocolIECriticality{Value: ie.CriticalityReject})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *PWSRestartIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PWSRestartIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 1
		if protocolIeId == ie.ProtocolIEIDCellIDListForRestart {
			// check if ie is duplicated
			if x.CellIDListForRestart != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: CellIDListForRestart")
			...
			x.CellIDListForRestart = &ie.CellIDListForRestart{}
			err = x.CellIDListForRestart.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDTAIListForRestart {
			// check if ie is duplicated
			if x.TAIListForRestart != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: TAIListForRestart")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.TAIListForRestart = &ie.TAIListForRestart{}
			err = x.TAIListForRestart.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDEmergencyAreaIDListForRestart {
			// check if ie is duplicated
			if x.EmergencyAreaIDListForRestart != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: EmergencyAreaIDListForRestart")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.EmergencyAreaIDListForRestart = &ie.EmergencyAreaIDListForRestart{}
			err = x.EmergencyAreaIDListForRestart.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
	...
	if x.CellIDListForRestart == nil {
		...
		reportIe := ie.BuildAbstractSyntaxErrReportIe(ie.ProtocolIEIDCellIDListForRestart, ie.CriticalityReject)
		errTrace := errors.Errorf("mandatory IE CellIDListForRestart is missing")
		return ie.BuildAbstractSyntaxErr(
			x.ProcedureCode(),
			aper.Enumerated(x.MessageType()),
			x.Criticality(),
	...
	if x.TAIListForRestart == nil {
		...
		// Build Abstract Syntax Error (missing IE/IE Group)
		// TODO: support reporting more than one abstract syntax error
		reportIe := ie.BuildAbstractSyntaxErrReportIe(ie.ProtocolIEIDTAIListForRestart, ie.CriticalityReject)
		errTrace := errors.Errorf("mandatory IE TAIListForRestart is missing")
		return ie.BuildAbstractSyntaxErr(
			x.ProcedureCode(),
			aper.Enumerated(x.MessageType()),
			x.Criticality(),
