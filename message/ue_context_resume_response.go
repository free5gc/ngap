...
type UEContextResumeResponse struct {
	...
	PDUSessionResourceResumeListRESRes         *ie.PDUSessionResourceResumeListRESRes         // optional
	PDUSessionResourceFailedToResumeListRESRes *ie.PDUSessionResourceFailedToResumeListRESRes // optional
	SecurityContext                            *ie.SecurityContext                            // optional
	SuspendResponseIndication                  *ie.SuspendResponseIndication                  // optional
	ExtendedConnectedTime                      *ie.ExtendedConnectedTime                      // optional
	CriticalityDiagnostics                     *ie.CriticalityDiagnostics                     // optional
}

func (x *UEContextResumeResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *UEContextResumeResponse) ProcedureCode() int64 {
	return ProcedureCodeUEContextResume
}

func (x *UEContextResumeResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *UEContextResumeResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UEContextResumeResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	if x.PDUSessionResourceResumeListRESRes != nil {
		numIes++
	}
	if x.PDUSessionResourceFailedToResumeListRESRes != nil {
		numIes++
	}
	if x.SecurityContext != nil {
		numIes++
	}
	if x.SuspendResponseIndication != nil {
		numIes++
	}
	...
	// IE Field 3 (optional)
	if x.PDUSessionResourceResumeListRESRes != nil {
		err = x.PDUSessionResourceResumeListRESRes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceResumeListRESRes},
	...
	// IE Field 4 (optional)
	if x.PDUSessionResourceFailedToResumeListRESRes != nil {
		err = x.PDUSessionResourceFailedToResumeListRESRes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceFailedToResumeListRESRes},
			ie.ProtocolIECriticality{Value: ie.CriticalityReject})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 6 (optional)
	if x.SuspendResponseIndication != nil {
		err = x.SuspendResponseIndication.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDSuspendResponseIndication},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *UEContextResumeResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UEContextResumeResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceResumeListRESRes {
			// check if ie is duplicated
			if x.PDUSessionResourceResumeListRESRes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceResumeListRESRes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceResumeListRESRes = &ie.PDUSessionResourceResumeListRESRes{}
			err = x.PDUSessionResourceResumeListRESRes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceFailedToResumeListRESRes {
			// check if ie is duplicated
			if x.PDUSessionResourceFailedToResumeListRESRes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceFailedToResumeListRESRes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceFailedToResumeListRESRes = &ie.PDUSessionResourceFailedToResumeListRESRes{}
			err = x.PDUSessionResourceFailedToResumeListRESRes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 6
		if protocolIeId == ie.ProtocolIEIDSuspendResponseIndication {
			// check if ie is duplicated
			if x.SuspendResponseIndication != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: SuspendResponseIndication")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.SuspendResponseIndication = &ie.SuspendResponseIndication{}
			err = x.SuspendResponseIndication.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
