...
func (x *UEContextResumeFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *UEContextResumeFailure) ProcedureCode() int64 {
	return ProcedureCodeUEContextResume
}

func (x *UEContextResumeFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *UEContextResumeFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UEContextResumeFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UEContextResumeFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UEContextResumeFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
