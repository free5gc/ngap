...
func (x *MulticastSessionActivationRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *MulticastSessionActivationRequest) ProcedureCode() int64 {
	return ProcedureCodeMulticastSessionActivation
}

func (x *MulticastSessionActivationRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MulticastSessionActivationRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: MulticastSessionActivationRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MulticastSessionActivationRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MulticastSessionActivationRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
