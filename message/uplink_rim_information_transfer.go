...
func (x *UplinkRIMInformationTransfer) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *UplinkRIMInformationTransfer) ProcedureCode() int64 {
	return ProcedureCodeUplinkRIMInformationTransfer
}

func (x *UplinkRIMInformationTransfer) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *UplinkRIMInformationTransfer) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: UplinkRIMInformationTransfer (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *UplinkRIMInformationTransfer) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (UplinkRIMInformationTransfer) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
