...
type PDUSessionResourceSetupResponse struct {
	...
	PDUSessionResourceSetupListSURes         *ie.PDUSessionResourceSetupListSURes         // optional
	PDUSessionResourceFailedToSetupListSURes *ie.PDUSessionResourceFailedToSetupListSURes // optional
	CriticalityDiagnostics                   *ie.CriticalityDiagnostics                   // optional
	UserLocationInformation                  *ie.UserLocationInformation                  // optional
}

func (x *PDUSessionResourceSetupResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *PDUSessionResourceSetupResponse) ProcedureCode() int64 {
	return ProcedureCodePDUSessionResourceSetup
}

func (x *PDUSessionResourceSetupResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *PDUSessionResourceSetupResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: PDUSessionResourceSetupResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	if x.PDUSessionResourceSetupListSURes != nil {
		numIes++
	}
	if x.PDUSessionResourceFailedToSetupListSURes != nil {
		numIes++
	}
	...
	// IE Field 3 (optional)
	if x.PDUSessionResourceSetupListSURes != nil {
		err = x.PDUSessionResourceSetupListSURes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceSetupListSURes},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 4 (optional)
	if x.PDUSessionResourceFailedToSetupListSURes != nil {
		err = x.PDUSessionResourceFailedToSetupListSURes.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPDUSessionResourceFailedToSetupListSURes},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *PDUSessionResourceSetupResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PDUSessionResourceSetupResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceSetupListSURes {
			// check if ie is duplicated
			if x.PDUSessionResourceSetupListSURes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceSetupListSURes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceSetupListSURes = &ie.PDUSessionResourceSetupListSURes{}
			err = x.PDUSessionResourceSetupListSURes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDPDUSessionResourceFailedToSetupListSURes {
			// check if ie is duplicated
			if x.PDUSessionResourceFailedToSetupListSURes != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PDUSessionResourceFailedToSetupListSURes")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PDUSessionResourceFailedToSetupListSURes = &ie.PDUSessionResourceFailedToSetupListSURes{}
			err = x.PDUSessionResourceFailedToSetupListSURes.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
