...
type CellTrafficTrace struct {
	...
	NGRANTraceID                   *ie.NGRANTraceID          // mandatory
	NGRANCGI                       *ie.NGRANCGI              // mandatory
	TraceCollectionEntityIPAddress *ie.TransportLayerAddress // mandatory
	PrivacyIndicator               *ie.PrivacyIndicator      // optional
	TraceCollectionEntityURI       *ie.URIAddress            // optional
}

func (x *CellTrafficTrace) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *CellTrafficTrace) ProcedureCode() int64 {
	return ProcedureCodeCellTrafficTrace
}

func (x *CellTrafficTrace) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *CellTrafficTrace) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: CellTrafficTrace (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	if x.PrivacyIndicator != nil {
		numIes++
	}
	if x.TraceCollectionEntityURI != nil {
		numIes++
	}
	...
	if x.NGRANTraceID != nil {
		err = x.NGRANTraceID.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDNGRANTraceID},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	} else {
		return pd.Bytes(), errors.Errorf("mandatory field NGRANTraceID is missing")
	}

	// IE Field 4 (mandatory)
	if x.NGRANCGI != nil {
		err = x.NGRANCGI.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDNGRANCGI},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	} else {
		return pd.Bytes(), errors.Errorf("mandatory field NGRANCGI is missing")
	}

	// IE Field 5 (mandatory)
	if x.TraceCollectionEntityIPAddress != nil {
		err = x.TraceCollectionEntityIPAddress.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDTraceCollectionEntityIPAddress},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	} else {
		return pd.Bytes(), errors.Errorf("mandatory field TraceCollectionEntityIPAddress is missing")
	}

	// IE Field 6 (optional)
	if x.PrivacyIndicator != nil {
		err = x.PrivacyIndicator.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPrivacyIndicator},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 7 (optional)
	if x.TraceCollectionEntityURI != nil {
		err = x.TraceCollectionEntityURI.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDTraceCollectionEntityURI},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *CellTrafficTrace) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (CellTrafficTrace) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDNGRANTraceID {
			// check if ie is duplicated
			if x.NGRANTraceID != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: NGRANTraceID")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.NGRANTraceID = &ie.NGRANTraceID{}
			err = x.NGRANTraceID.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDNGRANCGI {
			// check if ie is duplicated
			if x.NGRANCGI != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: NGRANCGI")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.NGRANCGI = &ie.NGRANCGI{}
			err = x.NGRANCGI.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 5
		if protocolIeId == ie.ProtocolIEIDTraceCollectionEntityIPAddress {
			// check if ie is duplicated
			if x.TraceCollectionEntityIPAddress != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: TraceCollectionEntityIPAddress")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.TraceCollectionEntityIPAddress = &ie.TransportLayerAddress{}
			err = x.TraceCollectionEntityIPAddress.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 6
		if protocolIeId == ie.ProtocolIEIDPrivacyIndicator {
			// check if ie is duplicated
			if x.PrivacyIndicator != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PrivacyIndicator")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PrivacyIndicator = &ie.PrivacyIndicator{}
			err = x.PrivacyIndicator.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 7
		if protocolIeId == ie.ProtocolIEIDTraceCollectionEntityURI {
			// check if ie is duplicated
			if x.TraceCollectionEntityURI != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: TraceCollectionEntityURI")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.TraceCollectionEntityURI = &ie.URIAddress{}
			err = x.TraceCollectionEntityURI.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
	...
	// NGRANTraceID is mandatory but may be nil (ignored)

	// NGRANCGI is mandatory but may be nil (ignored)

	// TraceCollectionEntityIPAddress is mandatory but may be nil (ignored)
