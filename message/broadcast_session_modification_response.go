...
func (x *BroadcastSessionModificationResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *BroadcastSessionModificationResponse) ProcedureCode() int64 {
	return ProcedureCodeBroadcastSessionModification
}

func (x *BroadcastSessionModificationResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *BroadcastSessionModificationResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: BroadcastSessionModificationResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *BroadcastSessionModificationResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (BroadcastSessionModificationResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
