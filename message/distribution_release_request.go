...
func (x *DistributionReleaseRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *DistributionReleaseRequest) ProcedureCode() int64 {
	return ProcedureCodeDistributionRelease
}

func (x *DistributionReleaseRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *DistributionReleaseRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 2
	...
	// open type value: DistributionReleaseRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *DistributionReleaseRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (DistributionReleaseRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
