...
func (x *ECIDMeasurementTerminationCommand) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *ECIDMeasurementTerminationCommand) ProcedureCode() int64 {
	return ProcedureCodeECIDMeasurementTermination
}

func (x *ECIDMeasurementTerminationCommand) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *ECIDMeasurementTerminationCommand) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: ECIDMeasurementTerminationCommand (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *ECIDMeasurementTerminationCommand) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (ECIDMeasurementTerminationCommand) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
