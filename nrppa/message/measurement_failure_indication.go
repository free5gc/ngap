...
type MeasurementFailureIndication struct {
...
func (x *MeasurementFailureIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *MeasurementFailureIndication) ProcedureCode() int64 {
	return ProcedureCodeMeasurementFailureIndication
}

func (x *MeasurementFailureIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *MeasurementFailureIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: MeasurementFailureIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MeasurementFailureIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MeasurementFailureIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
