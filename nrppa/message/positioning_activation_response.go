...
type PositioningActivationResponse struct {
...
func (x *PositioningActivationResponse) MessageType() int64 {
	return MessageTypeSuccessfulOutcome
}

func (x *PositioningActivationResponse) ProcedureCode() int64 {
	return ProcedureCodePositioningActivation
}

func (x *PositioningActivationResponse) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *PositioningActivationResponse) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: PositioningActivationResponse (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *PositioningActivationResponse) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PositioningActivationResponse) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
