...
func (x *PositioningInformationFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *PositioningInformationFailure) ProcedureCode() int64 {
	return ProcedureCodePositioningInformationExchange
}

func (x *PositioningInformationFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *PositioningInformationFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: PositioningInformationFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *PositioningInformationFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PositioningInformationFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
