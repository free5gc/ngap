...
func (x *ECIDMeasurementFailureIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *ECIDMeasurementFailureIndication) ProcedureCode() int64 {
	return ProcedureCodeECIDMeasurementFailureIndication
}

func (x *ECIDMeasurementFailureIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *ECIDMeasurementFailureIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: ECIDMeasurementFailureIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *ECIDMeasurementFailureIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (ECIDMeasurementFailureIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
