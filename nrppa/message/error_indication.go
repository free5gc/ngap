...
type ErrorIndication struct {
	...
	Cause                  *ie.Cause                  // optional
	CriticalityDiagnostics *ie.CriticalityDiagnostics // optional,
}

func (x *ErrorIndication) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *ErrorIndication) ProcedureCode() int64 {
	return ProcedureCodeErrorIndication
}

func (x *ErrorIndication) Criticality() aper.Enumerated {
	return CriticalityIgnore
}

func (x *ErrorIndication) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: ErrorIndication (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *ErrorIndication) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (ErrorIndication) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
