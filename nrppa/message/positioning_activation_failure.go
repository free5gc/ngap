...
type PositioningActivationFailure struct {
	NRPPATransactionID     int64                      // mandatory
	Cause                  *ie.Cause                  // mandatory
	CriticalityDiagnostics *ie.CriticalityDiagnostics // optional
}

func (x *PositioningActivationFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *PositioningActivationFailure) ProcedureCode() int64 {
	return ProcedureCodePositioningActivation
}

func (x *PositioningActivationFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *PositioningActivationFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: PositioningActivationFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *PositioningActivationFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PositioningActivationFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
