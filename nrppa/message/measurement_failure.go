...
type MeasurementFailure struct {
...
func (x *MeasurementFailure) MessageType() int64 {
	return MessageTypeUnsuccessfulOutcome
}

func (x *MeasurementFailure) ProcedureCode() int64 {
	return ProcedureCodeMeasurement
}

func (x *MeasurementFailure) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *MeasurementFailure) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: MeasurementFailure (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
...
func (x *MeasurementFailure) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (MeasurementFailure) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
