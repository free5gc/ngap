...
type PositioningInformationRequest struct {
	...
	RequestedSRSTransmissionCharacteristics *ie.RequestedSRSTransmissionCharacteristics // optional
	UEReportingInformation                  *ie.UEReportingInformation                  // optional
	UETEGInfoRequest                        *ie.UETEGInfoRequest                        // optional
	UETEGReportingPeriodicity               *ie.UETEGReportingPeriodicity               // conditional
}

func (x *PositioningInformationRequest) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *PositioningInformationRequest) ProcedureCode() int64 {
	return ProcedureCodePositioningInformationExchange
}

func (x *PositioningInformationRequest) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *PositioningInformationRequest) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: PositioningInformationRequest (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	// IE Field 1 (optional)
	if x.RequestedSRSTransmissionCharacteristics != nil {
		err = x.RequestedSRSTransmissionCharacteristics.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDRequestedSRSTransmissionCharacteristics},
	...
	// IE Field 2 (optional)
	if x.UEReportingInformation != nil {
		err = x.UEReportingInformation.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDUEReportingInformation},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 3 (optional)
	if x.UETEGInfoRequest != nil {
		err = x.UETEGInfoRequest.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDUETEGInfoRequest},
			ie.ProtocolIECriticality{Value: ie.CriticalityIgnore})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	if x.UETEGReportingPeriodicity != nil {
		err = x.UETEGReportingPeriodicity.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDUETEGReportingPeriodicity},
...
func (x *PositioningInformationRequest) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (PositioningInformationRequest) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 1
		if protocolIeId == ie.ProtocolIEIDRequestedSRSTransmissionCharacteristics {
			// check if ie is duplicated
			if x.RequestedSRSTransmissionCharacteristics != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: RequestedSRSTransmissionCharacteristics")
			...
			x.RequestedSRSTransmissionCharacteristics = &ie.RequestedSRSTransmissionCharacteristics{}
			err = x.RequestedSRSTransmissionCharacteristics.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 2
		if protocolIeId == ie.ProtocolIEIDUEReportingInformation {
			// check if ie is duplicated
			if x.UEReportingInformation != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: UEReportingInformation")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.UEReportingInformation = &ie.UEReportingInformation{}
			err = x.UEReportingInformation.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDUETEGInfoRequest {
			// check if ie is duplicated
			if x.UETEGInfoRequest != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: UETEGInfoRequest")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.UETEGInfoRequest = &ie.UETEGInfoRequest{}
			err = x.UETEGInfoRequest.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 4
		if protocolIeId == ie.ProtocolIEIDUETEGReportingPeriodicity {
			// check if ie is duplicated
			if x.UETEGReportingPeriodicity != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: UETEGReportingPeriodicity")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.UETEGReportingPeriodicity = &ie.UETEGReportingPeriodicity{}
			err = x.UETEGReportingPeriodicity.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
