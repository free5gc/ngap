...
type AssistanceInformationControl struct {
	...
	AssistanceInformation     *ie.AssistanceInformation     // optional
	Broadcast                 *ie.Broadcast                 // optional
	PositioningBroadcastCells *ie.PositioningBroadcastCells // optional,
}

func (x *AssistanceInformationControl) MessageType() int64 {
	return MessageTypeInitiatingMessage
}

func (x *AssistanceInformationControl) ProcedureCode() int64 {
	return ProcedureCodeAssistanceInformationControl
}

func (x *AssistanceInformationControl) Criticality() aper.Enumerated {
	return CriticalityReject
}

func (x *AssistanceInformationControl) MarshalBinary() ([]byte, error) {
	...
	*vLb, *vUb = 0, 32767
	...
	// open type value: AssistanceInformationControl (SEQUENCE)
	optPresentFlag = []bool{} // no optional field
	...
	*sLb, *sUb = 0, 65535
	...
	// IE Field 1 (optional)
	if x.AssistanceInformation != nil {
		err = x.AssistanceInformation.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDAssistanceInformation},
	...
	// IE Field 2 (optional)
	if x.Broadcast != nil {
		err = x.Broadcast.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDBroadcast},
			ie.ProtocolIECriticality{Value: ie.CriticalityReject})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
	...
	// IE Field 3 (optional,)
	if x.PositioningBroadcastCells != nil {
		err = x.PositioningBroadcastCells.WriteIE(pdOpenType,
			ie.ProtocolIEID{Value: ie.ProtocolIEIDPositioningBroadcastCells},
			ie.ProtocolIECriticality{Value: ie.CriticalityReject})
		if err != nil {
			return pd.Bytes(), errors.Wrap(err, "message marshal failed")
		}
...
func (x *AssistanceInformationControl) UnmarshalBinary(marshalled []byte) error {
	...
	if err != nil {
		return ie.BuildTransferSyntaxErr(errors.Wrap(err,
			"asn.1 decode message Value (AssistanceInformationControl) sequence error"))
	}
	// sequence element: ProtocolIE-Container (SEQUENCE OF)
	*sLb, *sUb = 0, 65535
	// get number of ies
	...
	for i := 0; i < int(numIes); i++ {
		...
		// IE Field 1
		if protocolIeId == ie.ProtocolIEIDAssistanceInformation {
			// check if ie is duplicated
			if x.AssistanceInformation != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: AssistanceInformation")
			...
			x.AssistanceInformation = &ie.AssistanceInformation{}
			err = x.AssistanceInformation.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 2
		if protocolIeId == ie.ProtocolIEIDBroadcast {
			// check if ie is duplicated
			if x.Broadcast != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: Broadcast")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.Broadcast = &ie.Broadcast{}
			err = x.Broadcast.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
		...
		// IE Field 3
		if protocolIeId == ie.ProtocolIEIDPositioningBroadcastCells {
			// check if ie is duplicated
			if x.PositioningBroadcastCells != nil {
				// Build Abstract Syntax Error (Falsely Constructed Message)
				errTrace := errors.Errorf("Duplicated IE: PositioningBroadcastCells")
				return ie.BuildAbstractSyntaxErr(
					x.ProcedureCode(),
					aper.Enumerated(x.MessageType()),
					x.Criticality(),
			...
			x.PositioningBroadcastCells = &ie.PositioningBroadcastCells{}
			err = x.PositioningBroadcastCells.ReadIE(pdOpenType)
			if err != nil {
				return errors.Wrap(err, "message unmarshal failed")
			}
			continue
