...
var _ ProtocolIE = &SCS960{}

type SCS960 struct {
	Value int64 // valueLB:0,valueUB:639
}

func (x *SCS960) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SCS960) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *SCS960) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SCS960) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
