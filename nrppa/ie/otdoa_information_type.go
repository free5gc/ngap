...
var _ ProtocolIE = &OTDOAInformationType{}

type OTDOAInformationType struct {
	List []ProtocolIESingleContainerOTDOAInformationTypeItemIEs // sizeLB:1,sizeUB:63
}

func (x *OTDOAInformationType) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *OTDOAInformationType) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 63
	...
	x.List = []ProtocolIESingleContainerOTDOAInformationTypeItemIEs{}
	for i := 0; i < int(numElementsList); i++ {
		var val ProtocolIESingleContainerOTDOAInformationTypeItemIEs
...
func (x *OTDOAInformationType) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *OTDOAInformationType) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
