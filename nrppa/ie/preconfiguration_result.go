...
var _ ProtocolIE = &PreconfigurationResult{}

type PreconfigurationResult struct {
	Value aper.BitString // sizeLB:8,sizeUB:8
}

func (x *PreconfigurationResult) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *PreconfigurationResult) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *PreconfigurationResult) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *PreconfigurationResult) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
