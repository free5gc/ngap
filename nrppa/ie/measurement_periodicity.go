...
var _ ProtocolIE = &MeasurementPeriodicity{}
...
const ( /* Enum Type */
	...
	MeasurementPeriodicityPresentMs20480  aper.Enumerated = 13
	MeasurementPeriodicityPresentMs40960  aper.Enumerated = 14
	MeasurementPeriodicityPresentExtended aper.Enumerated = 15
)
...
func (x *MeasurementPeriodicity) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *MeasurementPeriodicity) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *MeasurementPeriodicity) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *MeasurementPeriodicity) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
