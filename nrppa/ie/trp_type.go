...
var _ ProtocolIE = &TRPType{}

const ( /* Enum Type */
	TRPTypePresentPrsOnlyTP aper.Enumerated = 0
	TRPTypePresentSrsOnlyRP aper.Enumerated = 1
	TRPTypePresentTp        aper.Enumerated = 2
	TRPTypePresentRp        aper.Enumerated = 3
	TRPTypePresentTrp       aper.Enumerated = 4
)
...
func (x *TRPType) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *TRPType) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *TRPType) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *TRPType) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
