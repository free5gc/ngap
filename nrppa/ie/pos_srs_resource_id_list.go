...
type PosSRSResourceIDList struct {
	List []SRSPosResourceID // sizeLB:1,sizeUB:64
}

func (x *PosSRSResourceIDList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *PosSRSResourceIDList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
