...
// Choice type and its Read/Write is defined elsewhere
func (alt1 CauseProtocol) CauseAltIndex() int64 {
	return int64(1)
}

// Choice type and its Read/Write is defined elsewhere
func (alt2 CauseMisc) CauseAltIndex() int64 {
	return int64(2)
}

// Choice type and its Read/Write is defined elsewhere
func (alt3 ProtocolIESingleContainerCauseExtensionIE) CauseAltIndex() int64 {
	return int64(3)
}
...
func (x *Cause) Read(pd *aper.PerBitData) error {
	...
	if option_idx == 0 {
		...
		x.Choice = new(ProtocolIESingleContainerCauseExtensionIE)
	} else {
