...
var _ ProtocolIE = &UETEGInfoRequest{}

const ( /* Enum Type */
	UETEGInfoRequestPresentOnDemand aper.Enumerated = 0
	UETEGInfoRequestPresentPeriodic aper.Enumerated = 1
	UETEGInfoRequestPresentStop     aper.Enumerated = 2
)

type UETEGInfoRequest struct {
	Value aper.Enumerated // valueExt,valueLB:0,valueUB:2
}

func (x *UETEGInfoRequest) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UETEGInfoRequest) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *UETEGInfoRequest) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UETEGInfoRequest) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
