...
var _ ProtocolIE = &SCS480{}

type SCS480 struct {
	Value int64 // valueLB:0,valueUB:319
}

func (x *SCS480) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *SCS480) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *SCS480) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *SCS480) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
