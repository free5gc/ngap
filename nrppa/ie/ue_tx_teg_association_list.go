...
var _ ProtocolIE = &UETxTEGAssociationList{}

type UETxTEGAssociationList struct {
	List []UETxTEGAssociationItem // valueExt,sizeLB:1,sizeUB:256
}

func (x *UETxTEGAssociationList) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *UETxTEGAssociationList) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
	...
	*sLb, *sUb = 1, 256
	...
	x.List = []UETxTEGAssociationItem{}
	for i := 0; i < int(numElementsList); i++ {
		var val UETxTEGAssociationItem
...
func (x *UETxTEGAssociationList) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *UETxTEGAssociationList) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
