...
var _ ProtocolIE = &RelativeTime1900{}

type RelativeTime1900 struct {
	Value aper.BitString // sizeLB:64,sizeUB:64
}

func (x *RelativeTime1900) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *RelativeTime1900) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *RelativeTime1900) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *RelativeTime1900) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
