...
var _ ProtocolIE = &RequestType{}

const ( /* Enum Type */
	RequestTypePresentActivate   aper.Enumerated = 0
	RequestTypePresentDeactivate aper.Enumerated = 1
)
...
func (x *RequestType) Write(pd *aper.PerBitData) error {
	var err error
...
func (x *RequestType) Read(pd *aper.PerBitData) error {
	var err error
	var sLb, sUb *uint64 = new(uint64), new(uint64)
	var vLb, vUb *int64 = new(int64), new(int64)
...
func (x *RequestType) WriteIE(pd *aper.PerBitData, id ProtocolIEID, criticality ProtocolIECriticality) error {
...
func (x *RequestType) ReadIE(pd *aper.PerBitData) error {
	// Protocol IE (ProtocolIE-Field in 38.413) is a SEQUENCE type
	optPresentFlag := []bool{} // no optional field
