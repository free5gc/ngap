...
func TestSingleBitStringLegacyUnmarshal(t *testing.T) {
	for i, test := range singleBitStringTestData {
		out := reflect.New(reflect.TypeOf(test.unmarshalled))
		err := LegacyUnmarshal(test.marshalled, out.Interface())
		if err != nil {
			t.Errorf("  [ERROR]: %s", err.Error())
		} else if reflect.DeepEqual(test.unmarshalled, out.Elem().Interface()) {
			continue
		}
		t.Errorf("[FAIL]\n")
...
func BenchmarkSingleBitStringLegacyUnmarshal(b *testing.B) {
	for i := 0; i < b.N; i++ {
		for _, test := range singleBitStringTestData {
			out := reflect.New(reflect.TypeOf(test.unmarshalled))
			err := LegacyUnmarshal(test.marshalled, out.Interface())
			if err != nil {
...
func TestSingleBitStringLegacyMarshal(t *testing.T) {
	for i, test := range singleBitStringTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Errorf("  [ERROR]: %s", err.Error())
		} else if bytes.Equal(b, test.marshalled) {
			continue
		}
		t.Errorf("[FAIL]\n")
		t.Errorf("TEST %d is FAILED", i+1)
...
func TestStructBitStringLegacyUnmarshal(t *testing.T) {
...
func TestStructBitStringLegacyMarshal(t *testing.T) {
	for i, test := range structBitStringTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
		} else if bytes.Equal(test.marshalled, b) {
			continue
		}
		t.Errorf("[FAIL]\n")
		t.Errorf("TEST %d is FAILED", i+1)
...
func TestSingleOctetStringLegacyUnmarshal(t *testing.T) {
...
func TestSingleOctetStringLegacyMarshal(t *testing.T) {
	for i, test := range singleOctetStringTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Errorf("  [ERROR]: %s", err.Error())
...
func TestStructOctetStringLegacyUnmarshal(t *testing.T) {
...
func TestStructOctetStringLegacyMarshal(t *testing.T) {
	for i, test := range structOctetStringTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestSingleIntegerLegacyUnmarshal(t *testing.T) {
...
func TestSingleIntegerLegacyMarshal(t *testing.T) {
	for i, test := range integerTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Errorf("  [ERROR]: %s", err.Error())
...
func TestStructIntegerLegacyUnmarshal(t *testing.T) {
...
func TestStructIntegerLegacyMarshal(t *testing.T) {
	for i, test := range integerStructTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestSingleEnumLegacyUnmarshal(t *testing.T) {
...
func TestSingleEnumLegacyMarshal(t *testing.T) {
	for i, test := range enumTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestSinglePtrLegacyMarshal(t *testing.T) {
	for i, test := range ptrTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestSingleSequenceOfLegacyUnmarshal(t *testing.T) {
...
func TestSingleSequenceOfLegacyMarshal(t *testing.T) {
	for i, test := range seqofTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestChoiceLegacyUnmarshal(t *testing.T) {
...
func TestChoiceLegacyMarshal(t *testing.T) {
	for i, test := range choiceTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestStructPrintableStringUnmarshall(t *testing.T) {
...
func TestStructPrintableStringLegacyMarshal(t *testing.T) {
	for i, test := range printableStringStructTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
...
func TestOpenTypeLegacyUnmarshal(t *testing.T) {
...
func TestOpenTypeLegacyMarshal(t *testing.T) {
	for i, test := range openTypeTestData {
		b, err := LegacyMarshal(test.unmarshalled)
...
func TestSingleBooleanLegacyUnmarshal(t *testing.T) {
...
func TestSingleBooleanLegacyMarshal(t *testing.T) {
	for i, test := range boolTestData {
		b, err := LegacyMarshal(test.unmarshalled)
		if err != nil {
			t.Error("  [ERROR]: " + err.Error())
		} else if reflect.DeepEqual(test.marshalled, b) {
			continue
		}
		t.Errorf("[FAIL]\n")
		t.Errorf("TEST %d is FAILED", i+1)
