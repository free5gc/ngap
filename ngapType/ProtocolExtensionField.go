...
type HandoverCommandTransferExtIEsExtensionValue struct {
	Present                                int
	AdditionalDLForwardingUPTNLInformation *QosFlowPerTNLInformationList /* Do not find the Reference Field Value */
}
...
type HandoverRequestAcknowledgeTransferExtIEsExtensionValue struct {
	Present                               int
	AdditionalDLUPTNLInformationForHOList *AdditionalDLUPTNLInformationForHOList /* Do not find the Reference Field Value */
}
...
type MobilityRestrictionListExtIEsExtensionValue struct {
	Present                int
	LastEUTRANPLMNIdentity *PLMNIdentity /* Do not find the Reference Field Value */
}
...
type PDUSessionResourceItemCxtRelCplExtIEsExtensionValue struct {
	Present                                   int
	PDUSessionResourceReleaseResponseTransfer *aper.OctetString /* Do not find the Reference Field Value */
}
...
type PDUSessionResourceModifyIndicationTransferExtIEsExtensionValue struct {
	Present                      int
	SecondaryRATUsageInformation *SecondaryRATUsageInformation/* Do not find the Reference Field Value */ `aper:"valueExt"`
	SecurityResult               *SecurityResult/* Do not find the Reference Field Value */ `aper:"valueExt"`
}
...
type PDUSessionResourceModifyItemModReqExtIEsExtensionValue struct {
	Present int
	SNSSAI  *SNSSAI/* Do not find the Reference Field Value */ `aper:"valueExt"`
}
